...
#示例(```[
    ...
    #image("../images/typst-logo.jpg", width: 80%)
]```.text)
...
#示例(```[
    ...
    爱因斯坦首先提出了@相对论公式；根据#ref(<相对论公式>) 原子核发生裂变时会放出巨大能量。
]```.text)

#示例(```[
    @图表排版节 中的@软件作者对照表 列出了常见排版软件的作者和开发年代。#ref(<绪论章>)的@衰和帅 形象的展示了LaTeX和Typst功能上的区别。
]```.text)
